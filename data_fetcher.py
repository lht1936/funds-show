...
class OverseasFundDataFetcher:
    ...
    def __init__(self):
        self.overseas_keywords = settings.overseas_keywords_list
        self.qdii_symbol = settings.QDII_SYMBOL
        self.portfolio_year = settings.PORTFOLIO_YEAR
    ...
    def fetch_fund_holdings(self, fund_code: str) -> List[Dict]:
        holdings = []
        try:
            holdings_df = ak.fund_portfolio_em(code=fund_code, year=self.portfolio_year)
